...
class MoIP
{
    ...
    public function addFormaPagamento($forma,$args=null)
    {
        ...
        if($args!=null)
        {
            ...
            { 
                ...
                elseif (isset($args['data_vencimento']))
                {
                    $this->forma_pagamento_args = $args;
                }
                else
    ...
    public function getXML()
    {
        ...
        if (!empty($this->forma_pagamento))
        {
            ...
            foreach ($this->forma_pagamento as $forma)
            {
                ...
                if($forma == 'boleto' and !empty($this->forma_pagamento_args))
                {
                    ...
                    if(empty($this->forma_pagamento_args['data_vencimento'])) {
                        ...
                        $instrucao->addChild('Boleto')
                            ->addChild('DataVencimento',$this->forma_pagamento_args['data_vencimento']);
                    }
        ...
        if(!empty($this->comissoes))
        {
            ...
            foreach(array_keys($this->comissoes) as $k) {
                ...
                $comissionamento->addChild('Razao', 'Distribuicao');
    ...
    public function getResposta()
    {
        ...
        $return->xml     = (string)$this->xml_enviado;
