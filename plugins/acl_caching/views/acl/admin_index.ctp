                                ...
                                if($ctrl_info['permissions'][$role[$AclCaching->getAroModel()][$AclCaching->getAroPrimaryKey()]] == 1)
                                {
                                    ...
                                    if ($AclCaching->check(null, array('plugin' => 'acl_caching', 'controller' => 'acl', 'action' => 'admin_allow')))
                                    {
                                        echo $this->Html->image(
                                            ...
                                            array(
                                                'alt'     => __('Liberado - '.$role[$AclCaching->getAroModel()]['name'], true),
                                                'title'   => __('Liberado - '.$role[$AclCaching->getAroModel()]['name'], true),
                                                'class'   => 'pointer',
                                ...
                                else
                                {
                                    ...
                                    if ($AclCaching->check(null, array('plugin' => 'acl_caching', 'controller' => 'acl', 'action' => 'admin_deny')))
                                    {
                                        echo $this->Html->image(
                                            ...
                                            array(
                                                'alt'     => __('Bloqueado - '.$role[$AclCaching->getAroModel()]['name'], true),
                                                'title'   => __('Bloqueado - '.$role[$AclCaching->getAroModel()]['name'], true),
                                                'class'   => 'pointer',
